...
const APP_SHELL=[
  ...
  './backup-fix.js?v=2.7',
  './project-library.js?v=2.7',
  './automation-assist.js?v=2.7',
  './event-smart-narration.js?v=3.0',
  './static-smart-narration.js?v=2.9',
  './historical-context.js?v=2.7',
  './image-prompt-sync.js?v=2.7',
  './stage-fact-sync.js?v=2.7',
  './composition-lock.js?v=2.7',
  './event-visual-pack.js?v=3.1',
