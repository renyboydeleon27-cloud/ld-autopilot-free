(()=>{
  ...
  const hooks={
    tsunami:'The coast looked normal at first, but the ocean was already carrying a disaster toward shore.',
    earthquake:'There was almost no warning before the ground suddenly turned violent and the city began to break apart.',
    volcano:'The mountain had been building pressure beneath the surface, and then the eruption changed everything.',
    tornado:'The sky changed fast, and within minutes a violent tornado was tearing through the landscape.',
    cyclone:'The storm kept strengthening over warm water until destructive wind, rain, and surge reached the coast.',
    flood:'The water kept rising until roads, homes, and escape routes began disappearing beneath the flood.',
    landslide:'The slope looked stable until a massive section suddenly gave way and rushed downhill.',
    wildfire:'A dangerous fire grew into a fast-moving wall of flame, smoke, and embers.',
    insect:'That dark cloud was alive: a massive swarm was moving toward farmland and food supplies.',
    generic:'Everything looked normal at first, until the first clear sign that a major disaster was about to unfold.'
  };

  const shorts={
    earthquake:[
      'Daily life continues across the city or region before any visible sign of the coming earthquake.',
      'Stress builds along the fault as locked sections of the crust resist movement beneath the surface.',
      'The fault suddenly ruptures, releasing stored energy through powerful seismic waves.',
      'Violent shaking reaches streets and buildings, turning ordinary movement into immediate danger.',
      'Walls crack, utilities fail, and loose objects fall as the shaking intensifies.',
      'Buildings and infrastructure suffer major structural damage during the strongest motion.',
      'Roads, rail lines, bridges, factories, and neighborhoods are damaged as the crisis expands.',
      'Aftershocks and broken infrastructure make rescue and movement more difficult across the affected area.',
      'When the main shaking ends, survivors emerge into dust, debris, and unstable streets.',
      'Civilians and responders begin searching damaged buildings for survivors and trapped residents.',
      'Temporary camps and emergency aid appear as thousands face displacement and shortages.',
      'Homes, transport, utilities, workplaces, and public buildings remain heavily disrupted.',
      'Recovery begins as rubble is cleared and damaged neighborhoods start to rebuild.',
      'The earthquake leaves lasting lessons for safer construction, emergency planning, and preparedness.'
    ],
    tsunami:[
      ...
      'A powerful rupture suddenly displaces the seafloor and pushes a huge volume of water upward.',
      'Long tsunami waves spread outward across the ocean at high speed.',
      'Along some coasts, the sea withdraws unusually far and exposes the seabed.',
      'The first major wave reaches shore and surges inland with destructive force.',
      'Floodwater carries boats, timber, vehicles, and debris through coastal communities.',
      'The tsunami reaches wider coastlines and expands the disaster beyond the first impact zone.',
      'As water recedes, mud, wreckage, and standing water cover devastated areas.',
      'Survivors and responders begin rescue operations across damaged coastal communities.',
      'Displaced residents gather in temporary shelters while clean water and supplies become urgent.',
      'Ports, roads, homes, fishing fleets, businesses, and utilities suffer severe damage.',
      'Recovery begins as debris is cleared and essential structures are rebuilt.',
      'The disaster changes warning systems, evacuation planning, preparedness, and remembrance.'
    ],
    volcano:[
      'Life continues around the volcano while the mountain appears familiar and stable.',
      'Magma, gas, and pressure build beneath the volcano and increase geological unrest.',
      'Warning signs such as tremors, steam, gas, or ash become harder to ignore.',
      'The eruption begins as ash, gas, lava, or explosive material bursts from the vent.',
      'Ash darkens the sky and begins affecting nearby roads, roofs, and farmland.',
      'The main volcanic hazard surges outward with destructive force.',
      'Communities, roads, rivers, and infrastructure are overwhelmed as volcanic hazards spread.',
      'The wider region faces evacuation, ashfall, transport disruption, or secondary hazards.',
      'After the peak eruption, buried roads, damaged buildings, and ash-covered land remain.',
      'Survivors and responders confront the human cost and begin rescue operations.',
      'Displaced residents gather in safer areas while shelter and supplies become essential.',
      'Agriculture, transport, homes, utilities, and local economies suffer lasting damage.',
      'Cleanup and rebuilding begin as ash, debris, and deposits are removed.',
      'The eruption leaves lasting lessons for monitoring, evacuation, hazard maps, and preparedness.'
    ],
    tornado:[
      'An ordinary day continues beneath unstable air before severe weather fully develops.',
      'Powerful instability and wind shear organize a rotating thunderstorm.',
      'A funnel descends and the tornado reaches the ground.',
      ...
      'The tornado strikes with full force and tears through buildings and streets.',
      ...
      'Emergency shelters support people displaced from destroyed or unsafe homes.',
      ...
      'The disaster strengthens awareness of warnings, shelters, construction, and preparedness.'
    ],
    cyclone:[
      ...
      'Outer rain bands reach land and bring worsening wind, rain, and rising water.',
      'Storm surge and flooding begin pushing into low-lying communities.',
      ...
      'The storm affects a wider region with flooding, landslides, transport disruption, or outages.',
      'As the storm weakens, flooded streets, damaged buildings, and debris remain.',
      'Rescue teams and survivors move through damaged areas while access remains difficult.',
      ...
      'The cyclone leaves lessons for evacuation, coastal defenses, forecasting, and planning.'
    ],
    flood:[
      'Daily life continues near rivers or low-lying communities before water levels begin rising.',
      'Heavy rain, runoff, dam failure, or surge builds the flood threat.',
      'Water rises quickly and the first roads, fields, or low areas begin to disappear.',
      ...
      'The flood reaches destructive levels and enters homes and infrastructure.',
      ...
      'As water recedes, mud, debris, contamination, and standing water remain.',
      'Rescue operations focus on stranded residents and cut-off neighborhoods.',
      'Evacuees gather in shelters while clean water, food, and sanitation become priorities.',
      ...
      'The flood leaves lessons for warning systems, drainage, land use, and evacuation planning.'
    ],
    landslide:[
      'Life continues below unstable slopes or mountains before the ground begins to fail.',
      'Rain, earthquakes, erosion, ice, snow, or weak geology increases instability in the slope.',
      'Cracks, shifting ground, or falling rocks reveal that the slope is beginning to fail.',
      'A large mass suddenly breaks free and accelerates downhill.',
      'Rock, mud, snow, or debris gains speed and volume as it follows gravity.',
      ...
      'Homes, farms, roads, bridges, and infrastructure remain buried or damaged.',
      'Debris removal, slope stabilization, and rebuilding begin during recovery.',
      'The disaster leaves lessons for monitoring, hazard mapping, drainage, and land-use planning.'
    ],
    wildfire:[
      'Communities and forests sit under dry conditions before dangerous fire growth becomes visible.',
      ...
      'The burned area expands across a wider landscape before the advance finally slows.',
      ...
      'Homes, forests, farms, utilities, businesses, and habitat show extensive damage.',
    ...
    insect:[
      ...
      'Response teams organize surveillance and control operations where available.',
      'Agriculture, household income, markets, and food supplies face wider pressure.',
      'Control campaigns and monitoring reduce swarm pressure while recovery begins.',
  ...
  const observer=new MutationObserver(mutations=>{
    if(mutations.some(m=>m.type==='childList'&&m.target===stagesEl)){
      requestAnimationFrame(fillBlankNarrations);
    }
  });
